/********************************************************************************
** Form generated from reading UI file 'adminmanagemetroremovestation.ui'
**
...
#ifndef UI_ADMINMANAGEMETROREMOVESTATION_H
#define UI_ADMINMANAGEMETROREMOVESTATION_H
...
class Ui_AdminManageMetroRemoveStation
{
public:
    QGroupBox *groupBox;
    QLabel *holder_2;
    ...
    void setupUi(QDialog *AdminManageMetroRemoveStation)
    {
        if (AdminManageMetroRemoveStation->objectName().isEmpty())
            AdminManageMetroRemoveStation->setObjectName("AdminManageMetroRemoveStation");
        AdminManageMetroRemoveStation->resize(1200, 700);
        groupBox = new QGroupBox(AdminManageMetroRemoveStation);
...
"border-radius: 12;"));
        ...
        label_19->setStyleSheet(QString::fromUtf8("background-color: #BDBDBD;\n"
"border-radius: 1;"));
        ...
        pushButton_21->setStyleSheet(QString::fromUtf8("background-color: #D9D9D9;\n"
"border-radius: 1;"));
...
"border-radius: 12;"));
        ...
        label_39->setGeometry(QRect(420, 140, 60, 55));
        label_39->setStyleSheet(QString::fromUtf8("background-color: #BDBDBD;\n"
"border-radius: 12;"));
        ...
        label_43->setGeometry(QRect(250, 70, 421, 71));
        QFont font3;
        ...
        pushButton_12->setGeometry(QRect(200, 460, 261, 41));
...
"border-radius: 1;"));
        ...
        label_46->setGeometry(QRect(30, 290, 271, 51));
        QFont font4;
        font4.setFamilies({QString::fromUtf8("Arial")});
        font4.setPointSize(24);
        font4.setBold(false);
        label_46->setFont(font4);
        name_22 = new QLineEdit(groupBox_2);
        name_22->setObjectName("name_22");
        name_22->setGeometry(QRect(270, 290, 421, 51));
        QFont font5;
        font5.setPointSize(18);
        name_22->setFont(font5);
        name_22->setStyleSheet(QString::fromUtf8("background-color: white;\n"
"border-radius: 12;\n"
"color: black;"));
        label_45 = new QLabel(groupBox_2);
        label_45->setObjectName("label_45");
        label_45->setGeometry(QRect(30, 200, 271, 51));
        label_45->setFont(font4);
        name_20 = new QLineEdit(groupBox_2);
        name_20->setObjectName("name_20");
        name_20->setGeometry(QRect(270, 200, 421, 51));
...
"color: black;"));
        ...
        retranslateUi(AdminManageMetroRemoveStation);

        QMetaObject::connectSlotsByName(AdminManageMetroRemoveStation);
    } // setupUi

    void retranslateUi(QDialog *AdminManageMetroRemoveStation)
    {
        AdminManageMetroRemoveStation->setWindowTitle(QCoreApplication::translate("AdminManageMetroRemoveStation", "Dialog", nullptr));
        groupBox->setTitle(QString());
        holder_2->setText(QString());
        homepic_2->setText(QString());
        Metro_2->setText(QString());
        label_20->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Egypt Metro", nullptr));
        pushButton_11->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Log out", nullptr));
        username_2->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Admin", nullptr));
        userpic_2->setText(QString());
        label_19->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Home Page", nullptr));
        label_25->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Manage Metro", nullptr));
        label_27->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Subscription", nullptr));
        pushButton_21->setText(QString());
        pushButton_22->setText(QString());
        pushButton_23->setText(QString());
        pushButton_10->setText(QString());
        pushButton_25->setText(QString());
        label_29->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Stations", nullptr));
        label_30->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Tickets", nullptr));
        ...
        groupBox_2->setTitle(QCoreApplication::translate("AdminManageMetroRemoveStation", "GroupBox", nullptr));
        label_43->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Removing Station", nullptr));
        pushButton_12->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Save", nullptr));
        pushButton_15->setText(QString());
        homepic_3->setText(QString());
        label_46->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Line:", nullptr));
        label_45->setText(QCoreApplication::translate("AdminManageMetroRemoveStation", "Station Name:", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AdminManageMetroRemoveStation: public Ui_AdminManageMetroRemoveStation {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINMANAGEMETROREMOVESTATION_H
