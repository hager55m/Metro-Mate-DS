...
constexpr auto qt_meta_stringdata_CLASSSubscriptionENDCLASS = QtMocHelpers::stringData(
    "Subscription",
    "SwitchToHome",
    "",
    "SwitchToTicket",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSubscriptionENDCLASS_t qt_meta_stringdata_CLASSSubscriptionENDCLASS = {
    {
        QT_MOC_LITERAL(0, 12),  // "Subscription"
        QT_MOC_LITERAL(13, 12),  // "SwitchToHome"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 14),  // "SwitchToTicket"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSubscriptionENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Subscription::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CLASSSubscriptionENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSubscriptionENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSubscriptionENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Subscription, std::true_type>,
        // method 'SwitchToHome'
...
void Subscription::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Subscription::SwitchToHome; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Subscription::*)();
            if (_t _q_method = &Subscription::SwitchToTicket; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Subscription::*)();
            if (_t _q_method = &Subscription::SwitchToState; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Subscription::*)();
            if (_t _q_method = &Subscription::SwitchToUser; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Subscription::*)();
            if (_t _q_method = &Subscription::SwitchToLogin; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
...
void *Subscription::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSubscriptionENDCLASS.stringdata0))
...
// SIGNAL 0
void Subscription::SwitchToHome()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Subscription::SwitchToTicket()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Subscription::SwitchToState()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void Subscription::SwitchToUser()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void Subscription::SwitchToLogin()
{
