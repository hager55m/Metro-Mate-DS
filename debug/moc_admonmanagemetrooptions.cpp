...
Q_CONSTINIT static const qt_meta_stringdata_CLASSAdmonManageMetroOptionsENDCLASS_t qt_meta_stringdata_CLASSAdmonManageMetroOptionsENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(76, 17),  // "SwitchToAddTicket"
        QT_MOC_LITERAL(94, 16),  // "SwitchToAddMetro"
        QT_MOC_LITERAL(111, 17),  // "SwitchToAddRemove"
        QT_MOC_LITERAL(129, 15),  // "SwitchToStation"
        QT_MOC_LITERAL(145, 24),  // "on_pushButton_10_clicked"
        QT_MOC_LITERAL(170, 24),  // "on_pushButton_11_clicked"
        QT_MOC_LITERAL(195, 24),  // "on_pushButton_12_clicked"
        QT_MOC_LITERAL(220, 24),  // "on_pushButton_21_clicked"
        QT_MOC_LITERAL(245, 24),  // "on_pushButton_22_clicked"
        QT_MOC_LITERAL(270, 24),  // "on_pushButton_13_clicked"
        QT_MOC_LITERAL(295, 24)   // "on_pushButton_25_clicked"
    },
    "AdmonManageMetroOptions",
    "SwitchToAdminHome",
    "",
...
Q_CONSTINIT const QMetaObject AdmonManageMetroOptions::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAdmonManageMetroOptionsENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'SwitchToAddTicket'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'SwitchToAddMetro'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'SwitchToAddRemove'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void AdmonManageMetroOptions::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->SwitchToAddTicket(); break;
        case 4: _t->SwitchToAddMetro(); break;
        case 5: _t->SwitchToAddRemove(); break;
        ...
        {
            using _t = void (AdmonManageMetroOptions::*)();
            if (_t _q_method = &AdmonManageMetroOptions::SwitchToAddTicket; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (AdmonManageMetroOptions::*)();
            if (_t _q_method = &AdmonManageMetroOptions::SwitchToAddMetro; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (AdmonManageMetroOptions::*)();
            if (_t _q_method = &AdmonManageMetroOptions::SwitchToAddRemove; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (AdmonManageMetroOptions::*)();
            if (_t _q_method = &AdmonManageMetroOptions::SwitchToStation; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
...
// SIGNAL 3
void AdmonManageMetroOptions::SwitchToAddTicket()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void AdmonManageMetroOptions::SwitchToAddMetro()
{
    QMetaObject::activate(this, &staticMetaObject, 4, nullptr);
}

// SIGNAL 5
void AdmonManageMetroOptions::SwitchToAddRemove()
{
    QMetaObject::activate(this, &staticMetaObject, 5, nullptr);
}

// SIGNAL 6
void AdmonManageMetroOptions::SwitchToStation()
{
