...
""));
        ...
        metroimg->setGeometry(QRect(10, 620, 61, 51));
        label_13 = new QLabel(groupBox);
        label_13->setObjectName("label_13");
        label_13->setGeometry(QRect(80, 640, 161, 31));
        QFont font1;
...
"border-radius: 12;"));
        ...
        pushButton_11->setGeometry(QRect(240, 620, 191, 41));
        QFont font3;
...
"color: black;"));
        ...
        manimg = new QLabel(groupBox);
        manimg->setObjectName("manimg");
        manimg->setGeometry(QRect(20, 300, 51, 41));
...
"border-radius: 12;"));
        ...
        subimg = new QLabel(groupBox);
        subimg->setObjectName("subimg");
        subimg->setGeometry(QRect(20, 460, 49, 41));
...
"border-radius: 12;"));
        ...
        groupBox_4->setGeometry(QRect(480, 420, 691, 241));
