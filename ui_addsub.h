...
"border-radius: 12;"));
        ...
        mail->setGeometry(QRect(670, 220, 291, 41));
        QFont font3;
...
"color: black;"));
        ...
        mail_2->setGeometry(QRect(670, 300, 291, 41));
...
"height: 50px;"));
    ...
    void retranslateUi(QDockWidget *addsub)
    {
        ...
        pushButton->setText(QCoreApplication::translate("addsub", "Save", nullptr));
        m1->setText(QString());
    } // retranslateUi
