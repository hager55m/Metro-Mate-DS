/********************************************************************************
** Form generated from reading UI file 'adminmanagemetrootions.ui'
**
...
#ifndef UI_ADMINMANAGEMETROOTIONS_H
#define UI_ADMINMANAGEMETROOTIONS_H
...
class Ui_AdminManageMetroOtions
{
public:
    QGroupBox *groupBox;
    QLabel *holder_2;
    ...
    {
        if (AdminManageMetroOtions->objectName().isEmpty())
            AdminManageMetroOtions->setObjectName("AdminManageMetroOtions");
        AdminManageMetroOtions->resize(1200, 700);
        groupBox = new QGroupBox(AdminManageMetroOtions);
...
"border-radius: 1;"));
        ...
        label_27->setGeometry(QRect(80, 460, 171, 41));
        label_27->setFont(font2);
        pushButton_21 = new QPushButton(groupBox);
        pushButton_21->setObjectName("pushButton_21");
        pushButton_21->setGeometry(QRect(0, 300, 461, 71));
...
"border-radius: 12;"));
        ...
        groupBox_2->setGeometry(QRect(459, 0, 821, 751));
...
"color: black;"));
        ...
        retranslateUi(AdminManageMetroOtions);

        QMetaObject::connectSlotsByName(AdminManageMetroOtions);
    } // setupUi

    void retranslateUi(QDialog *AdminManageMetroOtions)
    {
        AdminManageMetroOtions->setWindowTitle(QCoreApplication::translate("AdminManageMetroOtions", "Dialog", nullptr));
        groupBox->setTitle(QString());
        holder_2->setText(QString());
        Metro_2->setText(QString());
        label_20->setText(QCoreApplication::translate("AdminManageMetroOtions", "Egypt Metro", nullptr));
        pushButton_11->setText(QCoreApplication::translate("AdminManageMetroOtions", "Log out", nullptr));
        username_2->setText(QCoreApplication::translate("AdminManageMetroOtions", "Admin", nullptr));
        userpic_2->setText(QString());
        label_19->setText(QCoreApplication::translate("AdminManageMetroOtions", "Home Page", nullptr));
        label_25->setText(QCoreApplication::translate("AdminManageMetroOtions", "Manage Metro", nullptr));
        label_27->setText(QCoreApplication::translate("AdminManageMetroOtions", "Subscription", nullptr));
        pushButton_21->setText(QString());
        pushButton_22->setText(QString());
        pushButton_23->setText(QString());
        pushButton_10->setText(QString());
        pushButton_25->setText(QString());
        label_29->setText(QCoreApplication::translate("AdminManageMetroOtions", "Stations", nullptr));
        label_30->setText(QCoreApplication::translate("AdminManageMetroOtions", "Tickets", nullptr));
...
namespace Ui {
    class AdminManageMetroOtions: public Ui_AdminManageMetroOtions {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINMANAGEMETROOTIONS_H
