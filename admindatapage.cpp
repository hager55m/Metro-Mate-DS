...
#include "ui_admindatapage.h"

AdminDataPage::AdminDataPage(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::AdminDataPage)
{
    ui->setupUi(this);
...
AdminDataPage::~AdminDataPage()
{
    delete ui;
}

void AdminDataPage::on_pushButton_21_clicked()
{
    emit SwitchToMangeMetro();
}


void AdminDataPage::on_pushButton_11_clicked()
{
    emit SwitchToLogin();
}


void AdminDataPage::on_pushButton_10_clicked()
{
    emit SwitchToHome();
}


void AdminDataPage::on_pushButton_22_clicked()
{
    emit SwitchToTicket();
}


void AdminDataPage::on_pushButton_23_clicked()
{
    emit SwitchToSub();
}


void AdminDataPage::on_pushButton_25_clicked()
{
    emit SwitchToStation();
}


void AdminDataPage::on_pushButton_12_clicked()
{
    emit SwitchToUserData();
}


void AdminDataPage::on_m1_clicked()
{
    emit SwitchToHome();
}
