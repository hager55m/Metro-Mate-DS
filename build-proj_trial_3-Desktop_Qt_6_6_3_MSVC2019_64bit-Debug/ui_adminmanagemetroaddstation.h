/********************************************************************************
** Form generated from reading UI file 'adminmanagemetroaddstation.ui'
**
...
#ifndef UI_ADMINMANAGEMETROADDSTATION_H
#define UI_ADMINMANAGEMETROADDSTATION_H
...
class Ui_AdminManageMetroAddStation
{
public:
    QGroupBox *groupBox;
    QLabel *holder_2;
    ...
    {
        if (AdminManageMetroAddStation->objectName().isEmpty())
            AdminManageMetroAddStation->setObjectName("AdminManageMetroAddStation");
        AdminManageMetroAddStation->resize(1200, 700);
        groupBox = new QGroupBox(AdminManageMetroAddStation);
...
"border-radius: 1;"));
        ...
        retranslateUi(AdminManageMetroAddStation);

        QMetaObject::connectSlotsByName(AdminManageMetroAddStation);
    } // setupUi
    ...
    void retranslateUi(QDialog *AdminManageMetroAddStation)
    {
        ...
        username_2->setText(QCoreApplication::translate("AdminManageMetroAddStation", "Admin", nullptr));
        userpic_2->setText(QString());
        label_19->setText(QCoreApplication::translate("AdminManageMetroAddStation", "Home Page", nullptr));
        label_25->setText(QCoreApplication::translate("AdminManageMetroAddStation", "Manage Metro", nullptr));
        label_27->setText(QCoreApplication::translate("AdminManageMetroAddStation", "Subscription", nullptr));
...
namespace Ui {
    class AdminManageMetroAddStation: public Ui_AdminManageMetroAddStation {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINMANAGEMETROADDSTATION_H
