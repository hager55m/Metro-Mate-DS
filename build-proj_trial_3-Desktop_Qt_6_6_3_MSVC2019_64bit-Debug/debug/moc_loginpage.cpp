...
#include "../../proj_trial_3/loginpage.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSLoginPageENDCLASS_t qt_meta_stringdata_CLASSLoginPageENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(43, 13),  // "SwitchToAdmin"
        QT_MOC_LITERAL(57, 16),  // "on_login_clicked"
        QT_MOC_LITERAL(74, 17)   // "on_signup_clicked"
    },
    "LoginPage",
    "SwitchTOSignup",
    "",
...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (LoginPage::*)();
            if (_t _q_method = &LoginPage::SwitchToAdmin; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
