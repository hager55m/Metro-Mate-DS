...
{
    ifstream file ("E:/brachmodefidDub/Metro-Mate-DS/img/stations_name.txt");
    if (!file.is_open()){
...
{
    ofstream outFile("E:/brachmodefidDub/Metro-Mate-DS/img/stations_name.txt");
...
void Station::readstations(){
    QFile file("E:/brachmodefidDub/Metro-Mate-DS/img/stations_name.txt");
